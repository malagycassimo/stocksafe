        ...
        <div key={item.label}>
          <button
            ...
            className={cn(
              ...
              "hover:bg-twilight hover:text-imperial",
              hasActive && "text-imperial",
              ...
              {item.submenu?.map((child) => (
                <Link
                  ...
                  className={cn(
                    ...
                    "hover:bg-twilight hover:text-imperial",
                    isActive(child.path) && "bg-twilight text-imperial border-r-4 border-imperial",
                    "pl-8",
                  )}
                >
    ...
    return (
      <Link
        ...
        className={cn(
          "flex items-center gap-3 px-4 py-3 text-sm font-medium transition-colors",
          "hover:bg-twilight hover:text-imperial",
          isActive(item.path) && "bg-twilight text-imperial border-r-4 border-imperial",
          item.highlight && "bg-yellow-50",
          isCollapsed && "justify-center px-2",
          level > 0 && "pl-8",
        )}
    ...
    >
      ...
      {!isCollapsed && (
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 bg-white">
          ...
          <button className="flex items-center gap-2 text-sm text-imperial hover:text-imperial font-medium">
