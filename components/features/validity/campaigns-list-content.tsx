          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">MZN 45.200</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-imperial">MZN 12.850</p>
              </div>
              ...
              <tbody>
                <tr className="border-b hover:bg-muted/50">
                  ...
                  <td className="p-2 text-right">
                    <p className="font-bold">MZN 8.920,00</p>
                ...
                <tr className="border-b hover:bg-muted/50 bg-red-50">
                  ...
                  <td className="p-2 text-right">
                    <p className="font-bold">MZN 5.200,00</p>
                ...
                <tr className="border-b hover:bg-muted/50">
                  ...
                  <td className="p-2 text-right">
                    <p className="font-bold">MZN 18.500,00</p>
                  </td>
                  <td className="p-2">
                    <div className="space-y-1">
