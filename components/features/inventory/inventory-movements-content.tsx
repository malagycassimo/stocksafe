          ...
          <CardContent className="pt-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Qtd: {entriesQty} un | {entriesValue.toLocaleString("pt-BR")} MT
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Qtd: {exitsQty} un | {exitsValue.toLocaleString("pt-BR")} MT
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <table className="w-full">
                      ...
                      <tr key={mov.id} className={`${rowClass} hover:bg-gray-100 transition-colors`}>
                        ...
                        <td className="px-4 py-3">
                          <div className="text-sm font-semibold">
                            {mov.totalValue.toLocaleString("pt-BR")} MT
                          </div>
                        </td>
                        <td className="px-4 py-3">
            ...
            <tfoot className="bg-gray-50 border-t border-gray-200 font-semibold">
              <tr>
                ...
                <td className="px-4 py-3 text-sm">
                  {(entriesValue + exitsValue).toLocaleString("pt-BR")} MT
                </td>
                <td colSpan={2}></td>
              </tr>
            </tfoot>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="font-semibold">{selectedMovement.unitValue.toFixed(2)} MT</div>
                    </div>
                    <div>
                      <Label>Valor Total</Label>
                      <div className="text-xl font-bold text-imperial">
                        {selectedMovement.totalValue.toLocaleString("pt-BR")} MT
                      </div>
                    </div>
                  </div>
                </CardContent>
